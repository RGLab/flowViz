...
### old approach that can't handle groups very gracefully
...
## ##          groups <- eval(substitute(groups), pd, environment(formula))
## ##          subset <- eval(substitute(subset), pd, environment(formula))
